...
const AVATAR_PALETTES = [
  {
    bg: 'from-[#3E7D5A]/30 via-[#5FA97D]/20 to-[#1B2119]',
    border: 'border-[#2A322A]',
    accent: '#5FA97D',
    fill: '#4E9A6E',
    secondary: '#3E7D5A',
  },
  {
    bg: 'from-[#4E9A6E]/30 via-[#3E7D5A]/25 to-[#1B2119]',
    border: 'border-[#2A322A]',
    accent: '#4E9A6E',
    fill: '#5FA97D',
    secondary: '#2A322A',
  ...
  {
    bg: 'from-[#3E7D5A]/25 via-[#2A322A] to-[#1B2119]',
    border: 'border-[#2A322A]',
    accent: '#5FA97D',
    fill: '#8B9A8C',
    secondary: '#3E7D5A',
  ...
  {
    bg: 'from-[#5FA97D]/20 via-[#4E9A6E]/20 to-[#1B2119]',
    border: 'border-[#2A322A]',
    accent: '#5FA97D',
    fill: '#4E9A6E',
    secondary: '#8B9A8C',
  ...
  {
    bg: 'from-[#2A322A] via-[#3E7D5A]/30 to-[#1B2119]',
    border: 'border-[#2A322A]',
    accent: '#8B9A8C',
    fill: '#5FA97D',
    secondary: '#3E7D5A',
  ...
  {
    bg: 'from-[#4E9A6E]/25 via-[#5FA97D]/20 to-[#1B2119]',
    border: 'border-[#2A322A]',
    accent: '#4E9A6E',
    fill: '#5FA97D',
    secondary: '#3E7D5A',
