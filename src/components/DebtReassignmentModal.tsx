        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="p-4 rounded-2xl bg-surface-base border border-surface-hairline flex items-center justify-between">
            <div className="text-xs">
              ...
              <span className="font-bold text-brand-coral text-sm">{creditor?.name}</span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full bg-surface-base border border-surface-hairline rounded-xl px-3 py-2.5 text-sm font-numeric font-bold text-ink-primary focus:border-brand-coral outline-none"
              />
          ...
          {/* Preview banner */}
          <div className="p-3.5 rounded-2xl bg-brand-coral/5 border border-brand-coral/20 text-xs text-ink-secondary flex items-center gap-3">
          ...
          <div className="pt-2 flex items-center justify-between border-t border-surface-hairline">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-brand-coral text-surface-base font-semibold text-xs flex items-center gap-2 shadow-coral hover:brightness-105 active:scale-95 disabled:opacity-50 transition-all"
            >
